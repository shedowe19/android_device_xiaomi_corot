...
# API
PRODUCT_SHIPPING_API_LEVEL := 33 # 指定预装 Android API 级别为 30, 例如 thyme 预装 Android 11, 故此处为 30
...
# Boot animation
TARGET_SCREEN_HEIGHT := 2712 # 指定屏幕高度为 2400
TARGET_SCREEN_WIDTH := 1220 # 指定屏幕宽度为 1080

# Common init scripts
PRODUCT_PACKAGES += \
    init.recovery.mt6895.rc # 编译额外的自定义 rc 脚本
...
# VNDK
PRODUCT_TARGET_VNDK_VERSION := 33 # 指定 VNDK 版本为 30, 该值可以在 vendor/build.prop 中找到